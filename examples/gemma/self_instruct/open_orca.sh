...
#$ -l node_q=1
#$ -l h_rt=24:00:00
#$ -o outputs/self_instruct/$JOB_ID.log
#$ -e outputs/self_instruct/$JOB_ID.log
#$ -p -5
...
OUTPUT_PATH=${DATASET_DIR}/lm_generated_${INDEX}.jsonl

echo "DATASET_PATH: $DATASET_PATH"

python examples/gemma/self_instruct/open_orca.py \
  --jsonl-path $DATASET_PATH \
  --json-input-key "processed_translated_instruction" \
